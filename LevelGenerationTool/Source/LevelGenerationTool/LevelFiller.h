...
public:
	...
	void SetPickupSideSpawnrate(float rate) { _pickupSideSpawnRate = FMath::Clamp<float>(rate, 0, 1); }
	...
	void SetEnemySideSpawnrate(float rate) { _enemySideSpawnRate = FMath::Clamp<float>(rate, 0, 1); }
